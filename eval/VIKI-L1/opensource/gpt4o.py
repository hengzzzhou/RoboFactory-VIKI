...
def process_sample(idx, sample, output_dir, model_name):
    ...
    # For image path, we'll save the binary image temporarily or use a placeholder
    # Since images are now stored as binary in the parquet file
    image_path = f"temp_image_{idx}.png"  # We'll need to handle this differently
...
def main():
    ...
    data=load_data("RoboFactory-VIKI/data/viki/VIKI-L1/test.parquet")
    output_dir = "eval/VIKI-L1/opensource/result_open"
    data=data[:300]
